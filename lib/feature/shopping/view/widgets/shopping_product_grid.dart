...
class ShoppingProductGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      // Use shoppingPageProducts instead of filteredProducts
      if (controller.shoppingPageProducts.isEmpty && !controller.isLoading.value) {
        return Center(
          child: Padding(
      ...
      final itemCount = controller.isLoading.value
          ? 6
          : controller.shoppingPageProducts.length;
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              final product = controller.isLoading.value
                  ? _getDummyProduct()
                  : controller.shoppingPageProducts[index];
